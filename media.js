...
const mediaSeries = {
  ...
  wk:[
    ...
    './images/preg/preg-15.JPG',
    './images/preg/preg-16.JPG',
    './images/preg/preg-17.JPG',
    './images/preg/preg-18.JPG',
    './images/preg/preg-19.JPG',
    './images/preg/preg-20.JPG',
    './images/preg/preg-21.JPG',
    './images/preg/preg-22.JPG',
    './images/preg/preg-23.JPG',
    './images/preg/preg-24.JPG',
  ...
  other: [
    ...
    //'./images/other/ch-3.jpg',
    //'./images/other/ch-4.jpg',
    //'./images/other/ch-5.jpg',
    //'./images/other/ch-6.jpg',
    ...
    //'./images/other/nd-1.GIF',
    
    './images/other/other-1.JPG',
    './images/other/other-2.JPG',
    './images/other/other-3.JPG',
    './images/other/other-4.JPG',
    //'./images/other/other-5.GIF',
    './images/other/other-6.JPG',
    //'./images/other/other-7.JPG',
    //'./images/other/other-8.JPG',
    //'./images/other/other-9.GIF',
    //'./images/other/other-10.GIF',
    './images/other/other-11.GIF',
    './images/other/other-12.GIF',
    './images/other/other-13.GIF',
    //'./images/other/other-14.GIF',
    //'./images/other/other-15.GIF',
    './images/other/other-16.GIF',
    ...
    './images/other/other-22.GIF',
    //'./images/other/other-23.GIF',
    ...
    //'./images/other/shemale-1.GIF',
    //'./images/other/shemale-2.GIF',
    './images/other/shemale-3.GIF',
    //'./images/other/shemale-4.GIF',
    ...
    //'./images/other/sv-5.gif',
    //'./images/other/sv-6.gif',
    ...
    //'./images/other/tb-5.JPG',
    //'./images/other/tb-6.JPG',
    //'./images/other/tb-7.JPG',
    //'./images/other/tb-8.JPG',
    //'./images/other/tb-9.JPG',
